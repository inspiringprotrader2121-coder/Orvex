...
export const env = {
  ...
  seoMarketSearchIpLimit: getNumber(process.env.SEO_MARKET_SEARCH_IP_LIMIT, 20),
  seoMarketSearchUserLimit: getNumber(process.env.SEO_MARKET_SEARCH_USER_LIMIT, 30),
  seoMarketSearchWindowSeconds: getNumber(process.env.SEO_MARKET_SEARCH_WINDOW_SECONDS, 60),
  socketTokenIpLimit: getNumber(process.env.SOCKET_TOKEN_IP_LIMIT, 40),
  socketTokenUserLimit: getNumber(process.env.SOCKET_TOKEN_USER_LIMIT, 60),
  socketTokenWindowSeconds: getNumber(process.env.SOCKET_TOKEN_WINDOW_SECONDS, 60),
